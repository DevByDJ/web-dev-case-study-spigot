...
<header class={'header mt-6 sticky z-[100] top-0' + (y > 0 ? 'py-4 ' : 'py-6 bg-transparent ')}>
  <a href="/">
  ...
  <div class="search-container">
    ...
    <input type="search" name="q" class="search-input py-2 text-sm rounded-md" placeholder="Search..." on:keydown={handleKeyPress} bind:value={searchQuery} autocomplete="off">
  </div>
  <a href="/" class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full">
